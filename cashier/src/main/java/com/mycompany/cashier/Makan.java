...
public class Makan extends javax.swing.JFrame {
    ...
    private void input_data(){
        try{
            ...
            String sql = "INSERT INTO makanan values('"+ID.getText()
                    +"','"+NAMA.getText()
                    +"','"+HARGA.getText()
                    +"')";
    ...
    private void IDOtomatis(){
        try{
            Connection kon=db_koneksi.koneksiDb();
            Statement st=kon.createStatement();
            String sql_id="SELECT * FROM makanan order by id_makanan desc";
            ResultSet rs=st.executeQuery(sql_id);
            if(rs.next()){
                String id_makanan=rs.getString("id_makanan").substring(2);
                String AN=""+(Integer.parseInt(id_makanan)+1);
                String Nol="";
                switch (AN.length()) {
                    case 1 -> Nol = "0000";
                    case 2 -> Nol = "000";
     ...
     public void LoadData(){
        Connection kon = db_koneksi.koneksiDb();
        Object header[]={"ID MAKANAN","NAMA","HARGA"};
     ...
     private void update(){
         try{
            ...
            String sql = "UPDATE makanan SET nama='"+NAMA.getText()
                    +"',harga ='"+HARGA.getText()
                    +"'WHERE id_makanan='"+ID.getText()+"'";
    ...
    private void delete(){
        try{
            ...
            String sql = "DELETE from makanan WHERE id_='"+ID.getText()+"'";
